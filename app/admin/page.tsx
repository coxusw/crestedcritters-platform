...
async function getAdminSnapshots() {
  ...
  const [
    ...
    safeCount(supabase.from("live_product_allowed_states").select("id", { count: "exact", head: true })),
  ...
  return {
    ...
    regulatory: {
      ...
      allowedRows: regulatoryAllowedRows,
    },
    permits: {
...
function buildTools(snapshots: Awaited<ReturnType<typeof getAdminSnapshots>>): AdminTool[] {
  return [
    ...
    },
    {
      ...
      status: "Live",
      stats: [
        { label: "Allowed Rows", value: snapshots.regulatory.allowedRows },
        { label: "Setup", value: "Simple" },
        { label: "Applications", value: snapshots.regulatory.applications },
        { label: "Shop Check", value: "On" },
      ],
      links: [
        { href: "/admin/regulatory", label: "Allowed States" },
