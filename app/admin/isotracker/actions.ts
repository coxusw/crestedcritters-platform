...
function buildPermitDraft(
  ...
  return [
    ...
    `Intended use: ${species.intended_use || INITIAL_PERMIT_SUPPORT_DOC.intendedUse}`,
    "",
    "Purpose of movement:",
    "Interstate shipment of captive-bred/cultured live invertebrates for contained use as bioactive cleanup crew organisms and pets. Organisms are not intended for outdoor release, environmental release, agricultural release, field release, research release, or biological control release.",
    "",
    "Source of organisms:",
    ...
    "",
    "Customer instructions and release prevention:",
    INITIAL_PERMIT_SUPPORT_DOC.releasePrevention,
    "",
    "Disposal / escape response:",
    INITIAL_PERMIT_SUPPORT_DOC.disposal,
    "",
